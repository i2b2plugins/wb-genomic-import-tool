...
--------------------------------------------------------
--  DDL for Table SEQUENCE_ONTOLOGY
--------------------------------------------------------
  ...
  CREATE TABLE SEQUENCE_ONTOLOGY
   ...
   CREATE INDEX META_FULLNAME_SEQ_ONT_IDX ON SEQUENCE_ONTOLOGY(C_FULLNAME)
;

   CREATE INDEX META_APPLIED_PATH__SEQ_ONT_IDX ON SEQUENCE_ONTOLOGY(M_APPLIED_PATH)
;
